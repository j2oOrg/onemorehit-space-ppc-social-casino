...
<head>
  ...
  <meta name="twitter:description" content="Accessibility and respect guide every update in the OneMoreHit.Space lounge.">
  ...
  <main id="main-content">
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <h1>Building OneMoreHit.Space for every body and device.</h1>
          <p>Static HTML, generous spacing, and predictable layouts keep OneMoreHit.Space friendly to screen readers, switch devices, and focus work.</p>
        </div>
        <div class="hero__card">
          ...
          <p>Email <a href="mailto:accessibility@onemorehit.space">accessibility@onemorehit.space</a> for feedback.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="shell content-grid">
        ...
        <article class="content-card content-card--wide">
          <h3>Need help?</h3>
          <p>Email <a href="mailto:accessibility@onemorehit.space">accessibility@onemorehit.space</a> with the barrier, browser, operating system, and assistive tech. We respond within two business days.</p>
          <p>If the request is urgent, contact <a href="mailto:support@onemorehit.space">support@onemorehit.space</a> or visit the <a href="/contact/">contact page</a>.</p>
        </article>
      </div>
    </section>
  </main>
