...
<head>
  ...
  <meta name="twitter:description" content="Respect is the jackpot. Review the rules that keep OneMoreHit.Space safe.">
    ...
    <section class="hero hero--sub">
      ...
      <div class="shell hero__grid">
        ...
        <div>
          ...
          <h1>OneMoreHit.Space community standards.</h1>
        ...
        <div class="hero__card">
          ...
          <p>Email <a href="mailto:support@onemorehit.space">support@onemorehit.space</a> with the username, room, and timestamp. We reply within one business day.</p>
    ...
    <section class="section">
      ...
      <div class="shell content-grid">
        ...
        <article class="content-card content-card--wide">
          ...
          <p>Curiosity, empathy, and zero tolerance for harassment anchor OneMoreHit.Space. Hold space for different cultures, speak inclusively, and respect quiet modes when someone needs a breather.</p>
        ...
        <article class="content-card">
          ...
          <ol>
            ...
            <li>Hit the in-room report tool or email <a href="mailto:support@onemorehit.space">support@onemorehit.space</a>.</li>
        ...
        <article class="content-card">
          ...
          <p>If you believe we made a mistake, email <a href="mailto:legal@onemorehit.space">legal@onemorehit.space</a> within 14 days with the username, date, and reason. A human reviews every appeal within 10 days.</p>
