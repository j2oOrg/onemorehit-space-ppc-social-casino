    ...
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <p>OneMoreHit.Space is a place where playlists, rituals, and gentle moderation matter as much as the spins. Here is how we hold space for each other every night.</p>
        </div>
    ...
    <section class="section">
      <div class="shell content-grid">
        <article class="content-card content-card--wide">
          ...
          <p>We call OneMoreHit.Space a social casino because people come first. Streaks are fun, but the real thrill is hearing someone's new mix, cheering a comeback, or watching a host steer the room toward a shared breath.</p>
    ...
    <section class="section">
      <div class="shell content-grid">
        <article class="content-card content-card--wide">
          ...
          <p>Drop into any room, introduce yourself, and share how you like to unwind. The moment you offer a song, an encouraging word, or a thoughtful pause, you're part of the OneMoreHit.Space story.</p>
