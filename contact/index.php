...
<head>
  ...
  <meta name="twitter:description" content="Talk directly with OneMoreHit.Space humans, care, context, and no canned responses.">
    ...
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <h1>Talk directly with OneMoreHit.Space humans.</h1>
    ...
    <section class="section">
      <div class="shell grid-split">
        <div class="content-card">
          ...
          <dl>
            <dt>Support</dt>
            <dd><a href="mailto:support@onemorehit.space">support@onemorehit.space</a></dd>
            <dt>Accessibility</dt>
            <dd><a href="mailto:accessibility@onemorehit.space">accessibility@onemorehit.space</a></dd>
            <dt>Legal & compliance</dt>
            <dd><a href="mailto:legal@onemorehit.space">legal@onemorehit.space</a></dd>
            <dt>Privacy</dt>
            <dd><a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a></dd>
          </dl>
        </div>
        <div class="content-card">
