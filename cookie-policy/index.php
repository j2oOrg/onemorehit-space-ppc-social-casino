  ...
  <main id="main-content">
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <p>We keep OneMoreHit.Space light: only essential cookies by default, with optional analytics if you opt in.</p>
    ...
    <section class="section">
      <div class="shell content-grid">
        ...
        <article class="content-card">
          <h2>Questions?</h2>
          <p>Email <a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a> or contact us if you have concerns about storage practices.</p>
        </article>
      </div>
    </section>
  </main>
