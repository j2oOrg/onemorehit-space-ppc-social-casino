  ...
  <main id="main-content">
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <p>OneMoreHit.Space runs fine without optional cookies. Use this page to double-check what's stored locally.</p>
        </div>
    ...
    <section class="section">
      <div class="shell content-grid">
        ...
        <article class="content-card">
          <h2>Need help?</h2>
          <p>Email <a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a> with your browser and OS. We'll send tailored steps within 24 hours.</p>
        </article>
      </div>
    </section>
  </main>
