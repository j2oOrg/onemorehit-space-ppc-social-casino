...
<head>
  ...
  <meta name="twitter:description" content="OneMoreHit.Space honors GDPR + CPRA. Here is the guide to every right and how to submit a request.">
    ...
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <h1>Your OneMoreHit.Space data rights.</h1>
          <p>OneMoreHit.Space complies with GDPR, UK GDPR, and CPRA. This guide explains each right and how to request it without friction.</p>
        </div>
        <div class="hero__card">
          <h3>Need a fast response?</h3>
          <p>Email <a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a> from the address tied to your lounge pass. We verify and respond within 30 days.</p>
    ...
    <section class="section">
      <div class="shell content-grid">
        ...
        <article class="content-card">
          <h3>How to submit</h3>
          <ol>
            <li>Contact <a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a> or use the <a href="/contact/">contact form</a>.</li>
        ...
        <article class="content-card">
          ...
          <p>Unsatisfied? Email <a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a> with "Appeal" in the subject. You may also contact your local supervisory authority or the California Privacy Protection Agency.</p>
        </article>
        <article class="content-card">
          <h3>Latest update</h3>
