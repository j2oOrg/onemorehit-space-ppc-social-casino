  ...
  <main id="main-content">
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <h1>How OneMoreHit.Space works.</h1>
          <p>Virtual-only, zero cash-outs, curated nightly drops.</p>
        </div>
        <div class="hero__card">
          <h3>Need walkthrough help?</h3>
          <p>Email <a href="mailto:support@onemorehit.space">support@onemorehit.space</a> and we'll set up a session.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="shell content-grid">
        ...
        <article class="content-card">
          <h2>Need a reset?</h2>
          <p>Contact <a href="mailto:support@onemorehit.space">support@onemorehit.space</a> to wipe progress, pause access, or check logs.</p>
        </article>
      </div>
    </section>
  </main>
