...
<head>
  ...
  <title>Leaderboard | OneMoreHit.Space</title>
  <meta name="description" content="Track OneMoreHit.Space leaderboard rankings. Progress is earned through free play only&mdash;no purchases, no pay-to-win.">
    ...
    <div class="container header-inner">
      <a class="brand" href="/">
        <span class="brand-icon" aria-hidden="true">
          <img src="/public/images/OneMoreHit.Space-icon.svg" alt="" role="presentation">
        </span>
        <span class="brand-text">
          <img src="/public/images/OneMoreHit.Space-wordmark.svg" alt="OneMoreHit.Space">
        </span>
      </a>
      <nav class="site-nav" aria-label="Primary">
        <a href="/" class="nav-link">Home</a>
<a href="/leaderboard/" class="nav-link is-active">Leaderboard</a>
        <a href="/daily-bonus/" class="nav-link">Daily Bonus</a>
  ...
  <main id="main-content">
    <section class="surface">
      <div class="container page-intro">
        ...
        <p class="lead">
          Rankings reset on the first day of every month at 00:00 UTC. XP is earned strictly through in-lounge play,
          daily streaks, and event challenges-never through purchases or real-money boosters.
        </p>
      </div>
    </section>
    ...
    <section class="container page-body">
      ...
      <section class="callout">
        ...
        <p class="muted">
          Suspicious activity (duplicate accounts, automation) is flagged by our moderation team. Accounts may be reset or closed
  ...
  <footer class="site-footer">
    <div class="container footer-grid">
      <div>
        ...
        <p class="footer-brand">OneMoreHit.Space</p>
        <p class="muted">
...
<li><a href="/leaderboard/">Leaderboard</a></li>
      ...
      <div>
        <h3>Contact</h3>
        <ul>
          <li><a href="mailto:support@onemorehit.space">support@onemorehit.space</a></li>
    ...
    <div class="container footer-bottom">
      <p class="muted">© 2025 DIGIBOX LTD OOD · OneMoreHit.Space. All rights reserved.</p>
