...
<head>
  ...
  <meta name="twitter:description" content="See what information OneMoreHit.Space stores and how to request changes.">
  ...
  <main id="main-content">
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        ...
        <div class="hero__card">
          ...
          <p>Email <a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a> for data requests or questions.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="shell content-grid">
        ...
        <article class="content-card">
          <h2>Security</h2>
          <p>Encryption in transit, tiered access controls, and annual risk reviews help protect your info. Report issues to <a href="mailto:security@onemorehit.space">security@onemorehit.space</a>.</p>
        </article>
        <article class="content-card">
          <h2>Your rights</h2>
        ...
        <article class="content-card">
          <h2>Children</h2>
          <p>OneMoreHit.Space is for adults 18+. We delete accounts belonging to minors as soon as we become aware.</p>
        </article>
        <article class="content-card">
          <h2>Contact</h2>
          <p>Privacy desk: <a href="mailto:privacy@onemorehit.space">privacy@onemorehit.space</a><br>
          Support: <a href="mailto:support@onemorehit.space">support@onemorehit.space</a></p>
        </article>
      </div>
    </section>
  </main>
