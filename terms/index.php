    ...
    <section class="hero hero--sub">
      <div class="shell hero__grid">
        <div>
          ...
          <h1>OneMoreHit.Space Terms of Service.</h1>
          <p>Last updated: November 2025. Please read carefully before enjoying the lounge.</p>
        </div>
        <div class="hero__card">
          <h3>Questions?</h3>
          <p>Email <a href="mailto:support@onemorehit.space">support@onemorehit.space</a> with the subject "Terms".</p>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="shell content-grid">
        ...
        <article class="content-card">
          ...
          <p>All artwork, copy, and code belong to OneMoreHit.Space unless otherwise noted. You may not reuse them without written consent.</p>
        </article>
        <article class="content-card">
          <h2>8. Suspension</h2>
        ...
        <article class="content-card content-card--wide">
          ...
          <p>The lounge is provided "as is" without warranties. OneMoreHit.Space and its affiliates are not liable for damages arising from your use, to the fullest extent permitted by law.</p>
        </article>
        <article class="content-card">
          <h2>10. Changes</h2>
